    ...
    <style>
        * {
        ...
        .sidebar {
            height: 100%;
            overflow-y: auto;
            background-color: #f8f9fa; /* or your desired background color */
        }
    </style>
</head>
...
<body class="hold-transition sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed text-sm">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar elevation-4 sidebar-light-navy">
            <!-- Brand Logo -->
            <a href="{{ route('portal.index') }}" class="brand-link text-sm">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column text-sm" data-widget="treeview" role="menu" data-accordion="false">
                        @if (Auth::check())
                        <!-- Show sidebar items for authenticated users -->
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('applicant.personal_profile') }}" class="nav-link">
